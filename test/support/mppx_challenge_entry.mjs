...
import { serialize, deserialize, from, credentialHeader } from '../../refs/mppx/src/Challenge.ts';

globalThis.MppxChallenge = { serialize, deserialize, from, credentialHeader };
