...
| mpp-rs #381 `cache-control: private` on body-verified paid responses (commit a8e5d6a, 2026-08-10) | Shared caches serving one client's paid response to others | Set on every successful verification — `plug.ex:447-451`; 402s carry `no-store` — `plug.ex:484`. mpp-rs #399 (2026-08-27) tightened the same guarantee to send-time semantics — 📋 Task 103 |
