...
**3 open items** as of 2026-09-11 — two draft advisories from the 2026-09-04 upstream sweep (tracked as Tasks 103 and 104) and one from the 2026-09-11 sweep (tracked as Task 111). Detail stays in the private advisories until each ships. The two inbound HIGH reports from that day shipped in 0.16.1 and were published the same day (`GHSA-5qrp-r24c-w6jr`, `GHSA-rpwj-vrf7-4x36`). Every advisory tracked against this repo is published with its
