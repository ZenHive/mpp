---
sha: dd8bcce22e50e28f564d833836c829e10a664920
short_sha: dd8bcce
...
# Audit: docs: GitHub security-sweep routine + FeePayerPolicy map; refresh lock (patch bumps)

**Original commit:** dd8bcce — `docs: GitHub security-sweep routine + FeePayerPolicy map; refresh lock (patch bumps)`
**Author:** E.FU
**Files touched:** 3 (AGENTS.md,CLAUDE.md mix.lock)
